...
abstract class RecursiveIterator[T](root: Json) extends AbstractIterator[Json] {

  protected var nextNode: Json = _
  protected var finished: Boolean = _
  protected var pause: Boolean = _
  protected var stack: List[T] = _

  protected def visitNode(node: Json): Unit
